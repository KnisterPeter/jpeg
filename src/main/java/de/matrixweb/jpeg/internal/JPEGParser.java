...
public class JPEGParser {
  ...
  static {
        ...
        rules.put("RuleName", new GrammarRule("RuleName", "RuleName", new GrammarNode[] {
                new GrammarNode(GrammarNodeMatcher.ASSIGN, "internal_RuleName_0"),
              }));
...
class GrammarNode {
  ...
  public boolean exec(final RuleMatchingContext context, final Input input) {
