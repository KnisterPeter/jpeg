 ...
 * @author markusw
 */
public class NotPredicateExpression extends Expression<NotPredicateExpression> {
   ...
   */
  @Override
  public NotPredicateExpression copy() {
    final NotPredicateExpression copy = new NotPredicateExpression();
