package de.matrixweb.jpeg.test;
...
public class JPEGTestParser {
  ...
  static {
        ...
        rules.put("BodyPart", new GrammarRule("BodyPart", new GrammarNode[] {
                new GrammarNode(GrammarNodeMatcher.ZERO_OR_MORE, "WS"),
        ...
        rules.put("SequenceExpressionPart1", new GrammarRule("SequenceExpressionPart1", new GrammarNode[] {
                new GrammarNode(GrammarNodeMatcher.RULE, "PredicateExpression"),
                new GrammarNode(GrammarNodeMatcher.ZERO_OR_MORE, "WS"),
              }));
        rules.put("PredicateExpression", new GrammarRule("PredicateExpression", new GrammarNode[] {
  ...
  ParsingNode parse(final String startRule, final Input input) {
    final GrammarRule rule = JPEGTestParser.rules.get(startRule);
    if (rule == null) {
    ...
    return new ParsingResult(new JPEGTestParser().parse("JPEG", new Input(input)));
  }
  
    public static ParsingResult Rule(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("Rule", new Input(input)));
  }
  
    public static ParsingResult Name(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("Name", new Input(input)));
  }
  
    public static ParsingResult NameChar(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("NameChar", new Input(input)));
  }
  
    public static ParsingResult NameEndChar(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("NameEndChar", new Input(input)));
  }
  
    public static ParsingResult Body(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("Body", new Input(input)));
  }
  
    public static ParsingResult BodyPart(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("BodyPart", new Input(input)));
  }
  
    public static ParsingResult ChoiceExpression(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("ChoiceExpression", new Input(input)));
  }
  
    public static ParsingResult ChoiceExpressionPart(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("ChoiceExpressionPart", new Input(input)));
  }
  
    public static ParsingResult SequenceExpression(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("SequenceExpression", new Input(input)));
  }
  
    public static ParsingResult SequenceExpressionPart1(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("SequenceExpressionPart1", new Input(input)));
  }
  
    public static ParsingResult PredicateExpression(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("PredicateExpression", new Input(input)));
  }
  
    public static ParsingResult AndPredicateExpression(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("AndPredicateExpression", new Input(input)));
  }
  
    public static ParsingResult NotPredicateExpression(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("NotPredicateExpression", new Input(input)));
  }
  
    public static ParsingResult AtomicExpression(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("AtomicExpression", new Input(input)));
  }
  
    public static ParsingResult OneOrMoreExpression(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("OneOrMoreExpression", new Input(input)));
  }
  
    public static ParsingResult ZeroOrMoreExpression(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("ZeroOrMoreExpression", new Input(input)));
  }
  
    public static ParsingResult OptionalExpression(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("OptionalExpression", new Input(input)));
  }
  
    public static ParsingResult AnyCharExpression(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("AnyCharExpression", new Input(input)));
  }
  
    public static ParsingResult EndOfInputExpression(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("EndOfInputExpression", new Input(input)));
  }
  
    public static ParsingResult RuleReferenceExpression(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("RuleReferenceExpression", new Input(input)));
  }
  
    public static ParsingResult RuleReferenceChar(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("RuleReferenceChar", new Input(input)));
  }
  
    public static ParsingResult RuleReferenceEnd(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("RuleReferenceEnd", new Input(input)));
  }
  
    public static ParsingResult Terminal(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("Terminal", new Input(input)));
  }
  
    public static ParsingResult InTerminalChar(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("InTerminalChar", new Input(input)));
  }
  
    public static ParsingResult WS(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("WS", new Input(input)));
  }
  
    public static ParsingResult COLON(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("COLON", new Input(input)));
  }
  
    public static ParsingResult SEMI(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("SEMI", new Input(input)));
  }
  
    public static ParsingResult QUOTE(final String input) {
    return new ParsingResult(new JPEGTestParser().parse("QUOTE", new Input(input)));
  }
...
class GrammarRule {
  ...
  public ParsingNode match(final JPEGTestParser parser, final Input input) {
...
class RuleMatchingContext {
  ...
  private final JPEGTestParser parser;
   ...
   * @param parser
   */
  public RuleMatchingContext(final JPEGTestParser parser) {
    this.parser = parser;
  }
   ...
   * @return the parser
   */
  public JPEGTestParser getParser() {
    return this.parser;
  }
